...
# 匯入股票產業資料
file = open(
    "C:\\Users\\gg837\\Desktop\\作業OR報告\\new\\fintech final\\台灣上市股票產業代碼.txt", "r"
)
js = file.read()
...
def get_stock_name(stockid):
    stock_df = pd.read_csv(
        "C:\\Users\\gg837\\Desktop\\作業OR報告\\new\\fintech final\\stockid\\股票名稱代碼.csv")
...
def result():
    if request.method == "POST":
        ...
        try:
            ...
            # 將查詢結果傳遞給 HTML 模板顯示
            return render_template(
            "stock.html", stock_code=stock_code, table_html=table_html, table2_html=table2_html,stID=stID,stName=stName,html_content=html_content
        )
